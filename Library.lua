...
local TextService = game.GetService(game, 'TextService');
...
function Library:CreateLabel(Properties, IsHud)
    local _Instance = Library.Create(Library, 'TextLabel', {
    ...
    Library.AddToRegistry(Library, _Instance, {
        TextColor3 = 'FontColor';
    }, IsHud);

    return Library.Create(Library, _Instance, Properties);
end;
...
function Library:Notify(Text, Time)
    local XSize, YSize = Library.GetTextBounds(Library, Text, Enum.Font.Code, 14);

    YSize = YSize + 7

    local NotifyOuter = Library.Create(Library, 'Frame', {
        BorderColor3 = Color3.new(0, 0, 0);
    ...
    local NotifyInner = Library.Create(Library, 'Frame', {
        BackgroundColor3 = Library.MainColor;
        BorderColor3 = Library.OutlineColor;
        BorderMode = Enum.BorderMode.Inset;
        Size = UDim2.new(1, 0, 1, 0);
    ...
    Library.AddToRegistry(Library, NotifyInner, {
        BackgroundColor3 = 'MainColor';
        BorderColor3 = 'OutlineColor';
    }, true);

    local InnerFrame = Library.Create(Library, 'Frame', {
        BackgroundColor3 = Color3.new(1, 1, 1);
        BorderSizePixel = 0;
        Position = UDim2.new(0, 1, 0, 1);
        Size = UDim2.new(1, -2, 1, -2);
    ...
    local Gradient = Library.Create(Library, 'UIGradient', {
        Color = ColorSequence.new({
            ColorSequenceKeypoint.new(0, Library.GetDarkerColor(Library, Library.MainColor)),
            ColorSequenceKeypoint.new(1, Library.MainColor),
        });
        Rotation = -90;
        Parent = InnerFrame;
    ...
    Library.AddToRegistry(Library, Gradient, {
        Color = function()
            return ColorSequence.new({
                ColorSequenceKeypoint.new(0, Library.GetDarkerColor(Library, Library.MainColor)),
                ColorSequenceKeypoint.new(1, Library.MainColor),
    ...
    local NotifyLabel = Library.CreateLabel(Library, {
    ...
    local LeftColor = Library.Create(Library, 'Frame', {
        BackgroundColor3 = Library.AccentColor;
        BorderSizePixel = 0;
        Position = UDim2.new(0, -1, 0, -1);
    ...
    Library.AddToRegistry(Library, LeftColor, {
        BackgroundColor3 = 'AccentColor';
    }, true);
